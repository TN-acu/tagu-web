...
async function setupQuiz() {
    try {
        ...
        const cleanTextData = textData.charCodeAt(0) === 0xFEFF ? textData.substring(1) : textData;
        const lines = cleanTextData.split('\n').filter(line => line.trim() !== '');
